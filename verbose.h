...
struct ParallelBoruvkaMST {
    ...
    ParallelArray<Edge> calculate_mst(Graph graph, u32 NUM_THREADS = omp_get_max_threads()) {
        ...
        while (graph.num_nodes() != 1) {
            ...
            std::cout << "init done in " << currentSeconds() - L << "\n";
            L = currentSeconds();
            ...
            std::cout << "shortest edges done in " << currentSeconds() - L << "\n";
            L = currentSeconds();
            ...
            std::cout << "selected edges done in " << currentSeconds() - L << "\n";
            L = currentSeconds();
            ...
            std::cout << "added edges done in " << currentSeconds() - L << "\n";
            L = currentSeconds();
            ...
            std::cout << "remaining edges done in " << currentSeconds() - L << "\n";
            L = currentSeconds();
            ...
            std::cout << "remaining nodes done in " << currentSeconds() - L << "\n";
            L = currentSeconds();
